  ...
  return (
    <div className="min-h-screen bg-[#f2f2f2] py-9 px-4">
      ...
      <main className="flex flex-1 flex-col p-6 max-w-screen">
        ...
        {/* Banner */}
        <div className="mt-6 rounded-xl bg-green-200 p-6 flex justify-between items-center">
          <div>
            <h2 className="text-xl font-semibold">Create and manage amazing content</h2>
            <p className="text-gray-700">Power up your admin tools with insights</p>
